...
SWEP.ViewModel = "models/weapons/shotguns/arc9_fas2_870.mdl"
...
SWEP.ShootSound = "870tact/rem870_tact_fire1.wav"                            -- Fire

SWEP.ShootSoundSilenced = "870tact/rem870_tact_suppressed_fire1.wav"                    -- Fire silenced
...
SWEP.Animations = {
     ["idle"] = {
		 ...
		 EjectAt = 0.15,
		 EventTable = {
		 {s = "870tact/rem870_tact_pumpback.wav", t = 0.05},
		 {s = "870tact/rem870_tact_pumpforward.wav", t = 0.22},
		 }
     },
	 	      ["cycle_iron"] = {
         Source = "cycle_iron",
    ...
    ["reload_start"] = {
		...
		RestoreAmmo = 1, -- Restores ammunition to clip
         EventTable = {
		 {s = foley_fast , t = 0},
		 {s = "870tact/rem870_tact_insert.wav" , t = 0.5},
		 {s = "870tact/rem870_tact_pumpback.wav", t = 1.25},
		 {s = "870tact/rem870_tact_pumpforward.wav", t = 1.40},
        },
    },
	    ["reload_insert"] = {
        Source = {"reload_loop"},
         EventTable = {
		 {s = foley_fast , t = 0},
		 {s = "870tact/rem870_tact_insert.wav" , t = 0.27},
        }
    },
    ["reload_finish"] = {
        Source = "reload_end",
