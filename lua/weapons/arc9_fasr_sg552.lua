...
SWEP.ViewModel = "models/weapons/rifles/arc9_fas2_sg552.mdl"
...
SWEP.Distance = 6000 -- In Hammer units, how far bullets can travel, period.
...
SWEP.RecoilUp = 0.68 -- Multiplier for vertical recoil
SWEP.RecoilSide = 0.30 -- Multiplier for vertical recoil
...
SWEP.Spread = 0.0009 -- sperad ARs Short
...
SWEP.ShootSound = "sg55x/sg552_fire1.wav"                          -- Fire

SWEP.ShootSoundSilenced = "sg55x/sg552_suppressed_fire1.wav"                    -- Fire silenced
...
SWEP.Animations = {
    ...
    ["reload"] = {
        ...
        EventTable = {
			...
			{s = foley_fast , t = 0.5},
			{s = "sg55x/sg550_magout.wav", t = 0.8},
			{s = "sg55x/sg550_magin.wav", t = 1.45},
			{s = foley_fast , t = 1.7},
			{s = grip , t = 2.3},
        },
    },
    ["reload_empty"] = {
        ...
        EventTable = {
		{s = foley_fast , t = 0},
		{s = "sg55x/sg550_magout_empty.wav", t = 0.35},
		{s = "handling/generic_magpouch_smg1.wav" , t = 1},
		{s = "sg55x/sg550_magin.wav" , t = 1.65},
		{s = "sg55x/sg550_boltback.wav" , t = 2.25},
		{s = "sg55x/sg550_boltforward.wav" , t = 2.39},
        },
	},
