...
SWEP.ViewModel = "models/weapons/smgs/arc9_fas2_mp5a5.mdl"
...
SWEP.ShootSound = "mp5/mp5_fire1.wav"                          -- Fire

SWEP.ShootSoundSilenced = "mp5/mp5sd_fire1.wav"                    -- Fire silenced
...
SWEP.Animations = {
 ...
 {s = grip , t = 1.8},		
    ...
    ["reload_empty"] = {
		...
		{s = foley_fast , t = 0.5},
			{s = "mp5/mp5_magout_empty.wav", t = 1},
			{s = foley_fast , t = 1.5},
			{s = "mp5/mp5_magin.wav", t = 2.1},
			{s = foley_fast , t = 2.3},
			{s = "mp5/mp5_boltforward.wav", t = 2.59},
			{s = grip , t = 3},
        },
	},
