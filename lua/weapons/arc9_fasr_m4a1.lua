...
SWEP.ViewModel = "models/weapons/rifles/arc9_fas2_m4a1.mdl"
...
SWEP.ShootSound = "m4a1/m4_fire1.wav"                          -- Fire

SWEP.ShootSoundSilenced = "m4a1/m4_suppressed_fire1.wav"                    -- Fire silenced
...
SWEP.Animations = {
    ...
    ["reload"] = {
		...
		{s = foley_fast , t = 0.5},
		{s = "m4a1/m4_magout.wav", t = 0.7},
		{s = "m4a1/m4_magin.wav", t =  1.06},
		{s = foley_fast , t = 1.2},
		{s = grip , t = 2},
        },
    },
    ["reload_empty"] = {
		...
		{s = foley_fast , t = 0.9},
		{s = "handling/generic_magpouch_smg1.wav" , t = 1.1},
		{s = "m4a1/m4_magin.wav", t = 1.42},
		{s = foley_fast , t = 1.6},
		{s = "m4a1/m4_boltcatch.wav", t = 1.95},
		{s = grip , t = 2.2},
        },
	},
