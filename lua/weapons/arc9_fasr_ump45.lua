...
SWEP.ViewModel = "models/weapons/smgs/arc9_fas2_ump45.mdl"
...
SWEP.Spread = 0.01 -- sperad ARs Short
...
SWEP.ShootSound = "ump45/ump45_fire1.wav"                          -- Fire

SWEP.ShootSoundSilenced = "ump45/ump45_suppressed_fire1.wav"                    -- Fire silenced
...
SWEP.ShellPitch = 85 -- for shell sounds
...
SWEP.Animations = {
    ...
    ["reload"] = {
        ...
        EventTable = {
			...
			{s = "ump45/ump45_magout.wav", t = 0.72},
			{s = foley_fast , t = 1},
			{s = "ump45/ump45_magin.wav", t = 1.32},
			{s = grip , t = 2.1},
        },
    },
    ["reload_empty"] = {
        ...
        EventTable = {
		{s = foley_fast , t = 0},
		{s = "ump45/ump45_magout.wav", t = 0.47},
		{s = foley_fast , t = 1},
		{s = "ump45/ump45_magin.wav", t = 1.73},
		{s = "ump45/ump45_boltforward.wav", t = 2.25},
		{s = grip , t = 2.5},
        },
	},
