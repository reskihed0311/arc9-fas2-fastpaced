...
SWEP.ViewModel = "models/weapons/dmrs/arc9_fas2_sr25.mdl"
...
SWEP.SpreadAddMove = 0.08-- Applied when speed is equal to walking speed.
...
SWEP.ShootSound = "sr25/sr25_fire1.wav"                          -- Fire

SWEP.ShootSoundSilenced = "sr25/sr25_suppressed_fire1.wav"                    -- Fire silenced
...
SWEP.IronSights = {
    Pos = Vector(-3.661, -4.547, 0.079),
}

SWEP.HasSights = true

-- Alternative "resting" position
SWEP.ActivePos = Vector(-1, -3.5, -0.5)
...
SWEP.Attachments = {

    {
        ...
        PrintName = "Under Barrel",
        DefaultName = "Your hand",
        Category = {"fas_grip"},
        Bone = "weapon",
        Pos = Vector(0, -1.5, 11.5),
        Ang = Angle(90, 0, -90),
    },
}
...
SWEP.Animations = {
    ...
    ["reload"] = {
		...
		{s = foley_fast , t = 1},
		{s = "sr25/sr25_magin.wav", t = 1.3},
		{s = foley_fast , t = 1.45},
		{s = "handling/generic_magpouch_smg1.wav", t = 1.8},
		{s = grip , t = 2.2},
        },
    },
    ["reload_empty"] = {
        ...
        EventTable = {
		{s = foley_fast , t = 0},
		{s = "sr25/sr25_magout_empty.wav", t = 0.6},
		{s = "handling/generic_magpouch_smg1.wav", t = 1},
		{s = foley_fast , t = 1.355},
		{s = "sr25/sr25_magin.wav", t = 1.85},
		{s = foley_fast , t = 2},
