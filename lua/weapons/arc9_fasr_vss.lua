...
SWEP.ViewModel = "models/weapons/dmrs/arc9_fas2_vss.mdl"
...
SWEP.ShootSoundSilenced = "vss/vss_suppressed_fire1.wav"                    -- Fire silenced
...
SWEP.IronSights = {
    Pos = Vector(-3.04, -3.632, 2.039),
}

SWEP.HasSights = true

-- Alternative "resting" position
SWEP.ActivePos = Vector(-1, -1.5, 0)
