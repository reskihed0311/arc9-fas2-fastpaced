...
SWEP.ViewModel = "models/weapons/smgs/arc9_fas2_bizon.mdl"
...
SWEP.ClipSize = 63 -- Self-explanatory.
...
SWEP.ShootSound = "bizon/bizon_fire1.wav"                          -- Fire

SWEP.ShootSoundSilenced = "bizon/bizon_suppressed_fire1.wav"                    -- Fire silenced
...
SWEP.Animations = {
    ...
    ["reload"] = {
        ...
        EventTable = {
				{s = foley_fast , t  = 0},
		{s = "bizon/bizon_maglatch.wav", t = 0.2},
		  {s = "bizon/bizon_magout_empty.wav", t = 0.5}, 
		  	{s = foley_fast , t  = 1},
		  {s = "bizon/bizon_maglatch.wav", t = 1.45},
		  {s = "bizon/bizon_magin.wav", t = 1.6},
    ...
    ["reload_empty"] = {
		...
		{s = "bizon/bizon_maglatch.wav", t = 0.2},
		  ...
		  {s = "bizon/bizon_maglatch.wav", t = 1.45},
		  {s = "bizon/bizon_magin.wav", t = 1.6},
		  {s = "bizon/bizon_boltpull.wav", t = 2},
		  {s = grip , t  = 2.5},
        },
	},
