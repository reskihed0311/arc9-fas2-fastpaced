...
SWEP.ViewModel = "models/weapons/battlerifles/arc9_fas2_fnfal.mdl"
...
SWEP.RangeMax = 5500-- In Hammer units, how far bullets can travel before dealing DamageMin.
...
SWEP.Spread = 0.0002 -- sperad BRs Long

SWEP.SpreadAddMove = 0.055-- Applied when speed is equal to walking speed.
SWEP.SpreadAddMidAir = 0.070 -- Applied when not touching the ground.
...
SWEP.ShootSound = "fnfal/fnfal_fire1.wav"                          -- Fire

SWEP.ShootSoundSilenced = "fnfal/fnfal_suppressed_fire1.wav"                    -- Fire silenced
...
SWEP.TriggerDownSound = "empty_battlerifles.wav"
SWEP.TriggerUpSound = ""
...
SWEP.Animations = {
    ...
    ["reload"] = {
		...
		{s = foley_fast , t = 0.4},
		{s = "fnfal/fnfal_magout.wav" , t = 0.8},
		{s = "fnfal/fnfal_magrattle.wav" , t = 1},
		{s = "fnfal/fnfal_magin.wav" , t = 1.3},
		{s = foley_fast , t = 1.5},
		{s = grip, t = 2.2},
        },
    },
    ["reload_empty"] = {
        ...
        EventTable = {
		    {s = foley_fast, t = 0},
			{s = "fnfal/fnfal_magout.wav" , t = 0.35},
			{s = "handling/generic_magpouch_smg1.wav" , t = 0.8},
			{s = foley_fast, t = 1},
			{s = "fnfal/fnfal_magrattle.wav" , t = 1.45},
			{s = "fnfal/fnfal_magin.wav" , t = 1.59},
			{s = foley_fast, t = 1.8},
			{s = "fnfal/fnfal_boltback.wav" , t = 2.01},
			{s = "fnfal/fnfal_boltrelease.wav" , t = 2.25},
			{s = grip, t = 2.5},
        },
	},
